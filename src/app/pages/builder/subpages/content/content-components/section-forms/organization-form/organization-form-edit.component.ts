...
@Component({
  selector: 'app-organization-form-edit',
  standalone: true,
  imports: [
    MaterialModule,
    ReactiveFormsModule,
  ...
  template: `
    <mat-expansion-panel
      class="organization-expansion-panel"
      [(expanded)]="isEditing"
    ...
    >
        ...
        <mat-panel-title>
          <div class="panel-title-content">
            <span class="organization-name">{{
              organizationData?.name || 'Tổ chức'
            }}</span>
            <span class="role-name" *ngIf="organizationData?.role">{{
      ...
      <div class="edit-form-container">
        <form [formGroup]="formGroup" class="organization-form">
          <!-- Row 1: Name and Role -->
          <div class="form-row">
            <mat-form-field appearance="outline" class="form-field">
              ...
              <input
                ...
                placeholder="Ví dụ: Hội sinh viên"
              />
            </mat-form-field>
            ...
            <mat-form-field appearance="outline" class="form-field">
              ...
              <input
                ...
                placeholder="Ví dụ: Thành viên, Chủ tịch"
              />
            </mat-form-field>
          </div>
          ...
          <div class="form-row checkbox-row">
            <mat-checkbox formControlName="current">
              Tôi hiện đang tham gia tổ chức này
            </mat-checkbox>
          </div>
          ...
          <div class="full-width editor-container">
            <div class="ngx-editor-wrapper">
              ...
              <ngx-editor
                ...
                [editor]="editor"
                [placeholder]="'Mô tả chi tiết về hoạt động và đóng góp...'"
...
export class OrganizationFormEditComponent
  implements OnInit, OnDestroy, OnChanges
{
  @Input() organizationData: Organization | null = null;
  @Input() isReadOnly: boolean = false;
  @Input() forceCollapse: boolean = false; // Thêm input để force đóng form
  @Output() formChange = new EventEmitter<Organization>();
  ...
  // Form Controls cho Organization - Giữ validation nhưng không block save
  ...
  ngOnInit(): void {
    ...
    if (this.organizationData) {
      this.formGroup.patchValue({
        ...
        role: this.organizationData.role || '',
        startDate: this.organizationData.startDate || '',
        endDate: this.organizationData.endDate || '',
        current: this.organizationData.current || false,
    ...
    const isNewForm =
      ...
      (!this.organizationData.name && !this.organizationData.role);
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes['organizationData'] && this.organizationData) {
      this.formGroup.patchValue({
        name: this.organizationData.name || '',
        role: this.organizationData.role || '',
        startDate: this.organizationData.startDate || '',
      ...
      if (this.organizationData.current) {
        this.endDateFormControl.disable();
      } else {
        this.endDateFormControl.enable();
      }
  ...
  saveForm(): void {
    ...
    if (organizationInfo.current) {
      organizationInfo.endDate = '';
    }

    this.formChange.emit(organizationInfo);
  }
